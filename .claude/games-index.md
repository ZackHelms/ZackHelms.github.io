...
|---|---|---|---|---|---|---|---|
| Neon Clash | `neon-clash/` | card-battler | drag-place, tap, tap-select | match-vs-ai, local-2p | card-deck, resource-economy, ai-opponent, rotated-2p-ui, area-of-effect | vs-ai, local-2p | `.claude/neon-clash.md` |
