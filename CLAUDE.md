...
| Turret Builder (`games/turret-builder/`) | `.claude/turret-builder.md` | Any work on the module-grid tower defense — the CD-spec'd module percentages (do not edit them), orthogonal sharing between turrets and walls, kinetic-vs-elemental damage typing and the scaling-armour rule, walls on the road, the cash/cores economy, the ~8-minute level pacing, and the two test suites |
