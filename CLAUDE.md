...
| Star Surge (`games/star-surge/`) | `.claude/star-surge.md` | Any work on the shmup — the canvas title screen (a logo spelled in enemy hulls over a procedural 3D dogfight), the station hub and routing, wave director, boss phases, powerups, bullet caps |
